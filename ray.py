...
def essai_tore():
	...
	camera=Camera( oeil, droite, regard, vertical, 1.5, 100, normalize3((0., -1., 2.)))
	camera.nom="tore"
	raycasting( camera, Prim( tore( 0.4, 1), (255,0, 255)))
...
def essai_boule():
	...
	camera=Camera( oeil, droite, regard, vertical, 1.5, 100, normalize3((0., -1., 2.)))
	camera.nom="boule"
	raycasting( camera, Prim( boule( (0., 2., -0.5), 1.), (0,255,255)))
#essai_scale()
#essai_rotaz()
#essai_trans()
def essai_inter():
...
def essai_inside():
        ...
        camera=Camera( oeil, droite, regard, vertical, 1.5, 50, normalize3((0., -1., 2.)))
        camera.nom="inside"
        raycasting( camera, Prim( boule( (0., 0.,0.), 1), (0,255,255)))
